...
if (isset($_REQUEST['data'])) {
	$escapedUser = \mysql_real_escape_string($user);
	$escapedData = \mysql_real_escape_string(\strip_tags($_REQUEST['data']));
	$query = "
		INSERT INTO `itu-ajax` (`login`, `cnt`, `dts`)
		VALUES ('$escapedUser', '$escapedData', CURRENT_TIMESTAMP)
	";
